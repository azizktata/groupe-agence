// mocks/sabre-revalidate-v2.mock.ts
// Contains revalidation response for round-trip flight between WAW and SPU (LOT Polish Airlines)
export const MOCK_SABRE_REVALIDATE_V2_RESPONSE = {
